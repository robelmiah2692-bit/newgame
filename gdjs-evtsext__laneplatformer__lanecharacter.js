...
gdjs.evtsExt__LanePlatformer__LaneCharacter.LaneCharacter = class LaneCharacter extends gdjs.RuntimeBehavior {
  ...
  applyBehaviorOverriding(behaviorOverriding) {
    ...
    if (behaviorOverriding.LaneDepth !== undefined)
      this._behaviorData.LaneDepth = behaviorOverriding.LaneDepth;
    if (behaviorOverriding.Lane !== undefined)
      this._behaviorData.Lane = behaviorOverriding.Lane;
    if (behaviorOverriding.TargetedLane !== undefined)
      this._behaviorData.TargetedLane = behaviorOverriding.TargetedLane;
    if (behaviorOverriding.HasChangedOfLane !== undefined)
      this._behaviorData.HasChangedOfLane = behaviorOverriding.HasChangedOfLane;
    if (behaviorOverriding.LaneMin !== undefined)
      this._behaviorData.LaneMin = behaviorOverriding.LaneMin;
    if (behaviorOverriding.LaneMax !== undefined)
      this._behaviorData.LaneMax = behaviorOverriding.LaneMax;
    if (behaviorOverriding.LaneChangeDuration !== undefined)
      this._behaviorData.LaneChangeDuration = behaviorOverriding.LaneChangeDuration;
...
gdjs.evtsExt__LanePlatformer__LaneCharacter.LaneCharacter.prototype.doStepPreEventsContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__LanePlatformer__LaneCharacter.LaneCharacter.prototype.doStepPostEventsContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__LanePlatformer__LaneCharacter.LaneCharacter.prototype.UpdateLaneContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__LanePlatformer__LaneCharacter.LaneCharacter.prototype.EnablePlatformOnLaneContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__LanePlatformer__LaneCharacter.LaneCharacter.prototype.IsObjectOnSameLaneContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__LanePlatformer__LaneCharacter.LaneCharacter.prototype.LaneOfContext.idToCallbackMap = new Map();
...
let isConditionTrue_0 = false;
{
{eventsFunctionContext.returnValue = Math.round(-(0.5) + eventsFunctionContext.getArgument("CenterY") / eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getLaneDepth());}
}
...
gdjs.evtsExt__LanePlatformer__LaneCharacter.LaneCharacter.prototype.LaneOf = function(CenterY, parentEventsFunctionContext) {
...
gdjs.evtsExt__LanePlatformer__LaneCharacter.LaneCharacter.prototype.LaneContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__LanePlatformer__LaneCharacter.LaneCharacter.prototype.SetLaneContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__LanePlatformer__LaneCharacter.LaneCharacter.prototype.MoveLeftContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__LanePlatformer__LaneCharacter.LaneCharacter.prototype.MoveRightContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__LanePlatformer__LaneCharacter.LaneCharacter.prototype.HasChangedOfLaneContext.idToCallbackMap = new Map();
